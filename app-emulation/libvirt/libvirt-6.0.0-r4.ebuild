...
LICENSE="LGPL-2.1"
IUSE="
	apparmor audit +caps +dbus dtrace firewalld fuse glusterfs iscsi iscsi-direct
	+libvirtd lvm libssh lxc +macvtap nfs nls numa openvz parted pcap
...
my_src_install() {
	...
	newbashcomp "${WORKDIR}/${PN}-${PV/-r*}/tools/bash-completion/vsh" virsh
